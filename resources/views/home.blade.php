<x-layouts>
  <section class="relative h-screen w-full overflow-hidden flex items-center justify-center">
    ...
    <div class="relative z-20 text-center px-4 max-w-5xl mx-auto">
      ...
      <p class="font-sans text-gray-200 text-sm md:text-lg mb-10 tracking-[0.2em] uppercase opacity-90 font-bold">
    ...
    <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce z-20 text-white/70">
      <div class="flex flex-col items-center gap-2">
        <span class="text-[10px] font-sans tracking-widest uppercase">Scroll Down</span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
        ...
        <div class="relative text-center md:text-left" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="flex items-center justify-center md:justify-start gap-3 mb-3 md:mb-4">
            ...
            <span class="text-xs md:text-sm font-sans font-bold tracking-[0.2em] text-primary uppercase">
              Who We Are
            </span>
          </div>
          ...
          <p class="font-sans text-gray-600 text-base md:text-lg leading-relaxed mb-6 md:mb-8 px-2 md:px-0">
            SBKSasirangan promotes the traditional fabrics of South Kalimantan. We advocate for a sustainable lifestyle
          ...
          <div class="flex justify-center md:justify-start">
            <a href="#"
              class="inline-flex items-center gap-3 px-6 py-2.5 md:px-8 md:py-3 bg-primary text-third rounded-full text-sm md:text-base font-medium transition-all duration-300 hover:bg-[#142e1f] hover:shadow-lg hover:shadow-primary/30 hover:-translate-y-1 group">
              <span>About Us</span>
              <i
