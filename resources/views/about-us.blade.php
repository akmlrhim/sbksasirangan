    ...
    <section class="relative pt-36 pb-20 md:pt-42 md:pb-32 bg-third">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div data-aos="fade-up">
          <span class="text-[#bfa15f] font-bold tracking-[0.2em] uppercase text-sm mb-4 block">
            {{ __('Our Story') }}
          </span>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div class="font-sans text-gray-600 text-lg leading-relaxed space-y-6" data-aos="fade-left">
            <p>
              <span class="text-5xl float-left mr-3 mt-[-10px] font-header text-secondary">S</span>
    ...
    <section class="py-24 relative overflow-hidden bg-third" id="services" x-data="{
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-10 md:mb-16" data-aos="fade-up">
          ...
          <h2 class="font-header text-4xl md:text-5xl text-primary mt-4">{{ __('Our Services') }}</h2>
          ...
          <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div class="md:col-span-9 text-center md:text-justify">
              <p class="text-primary font-medium text-sm md:text-base leading-relaxed font-sans">
                ...
                <span class="font-bold text-secondary text-xs md:text-sm bg-primary/5 px-1 rounded">
