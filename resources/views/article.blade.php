    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div class="mb-12" data-aos="fade-down">
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <span class="text-gray-400 text-sm font-medium">
            <i class="fa-regular fa-clock mr-1"></i> {{ $post->created_at->format('M d, Y') }}
          </span>
        </div>
      ...
      <div
        ...
        <div class="flex flex-col gap-2">
          <span class="text-xs font-bold text-primary uppercase tracking-[0.2em]">Article Source</span>
        ...
        <div class="flex flex-col md:items-end gap-3">
          <span class="text-xs font-bold text-primary uppercase tracking-[0.2em]">Share this Insight</span>
